...
export const DEFAULT_USERCASE_MVP_MICROPHONE_DOCUMENT = {
  ...
  "meta": {
    ...
    "exportedAt": "2026-06-24T12:20:53.808Z"
  },
  "signalGraph": {
    "nodes": [],
    "edges": []
  ...
  "scenario": {
    "initial": {
      ...
      "nodes": [
        ...
        {
          "id": "node-get-recorder-mvp-initial-bootstrap-1",
          "blockKind": "custom",
          "position": {
            "x": 896,
            "y": -600
        ...
        {
          "id": "node-make-recording-policy-mvp-initial-1",
          "blockKind": "custom",
          "position": {
            "x": 896,
            "y": -360
      ...
      "edges": [
        ...
        },
        {
          ...
          "sourceHandle": "exec-out",
          "target": "node-get-recorder-mvp-initial-bootstrap-1",
          "targetHandle": "exec-in",
          "kind": "exec"
        },
        {
        ...
        {
          "source": "node-get-recorder-mvp-initial-bootstrap-1",
          "sourceHandle": "exec-out",
        ...
        {
          "source": "node-make-recording-policy-mvp-initial-1",
          "sourceHandle": "policy",
          "target": "node-start-recording-bootstrap-v08-2",
          "targetHandle": "policy",
          "kind": "data",
