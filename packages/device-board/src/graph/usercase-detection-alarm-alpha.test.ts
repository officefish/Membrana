...
import { COMMUNITY_COMPETITION_USER_CASE_ENTRIES } from '../catalog/community-competition-user-case-entries.js';
import {
...
describe('usercase-detection-alarm-alpha (Phase 2α)', () => {
  ...
  it('каталог: entry community виден и грузит именно этот документ', () => {
    ...
    expect(
      COMMUNITY_COMPETITION_USER_CASE_ENTRIES.filter((e) => e.id === 'usercase-detection-alarm-alpha'),
    ).toHaveLength(1);
  });
