...
export const DEFAULT_USERCASE_MVP_MICROPHONE_ALPHA_ASYNC_V2_DOCUMENT = {
  "version": 2,
  "kind": "device-scenario",
  "deviceKind": "microphone",
  "meta": {
    "title": "MVP microphone · Alpha (Live Observation Pipeline, async v2)",
    "exportedAt": "2026-06-25T12:44:10.734Z",
  ...
  "scenario": {
      ...
      "main": {
        ...
        "nodes": [
          ...
          },
          {
            ...
            "label": "Observation tick::fn-alpha-observation-tick",
            "supportsAsync": true
          },
          {
    ...
    "functions": [
      ...
      },
      {
        ...
        "entry": "fn-alpha-observation-tick-input",
        "nodes": [
          {
            "id": "fn-alpha-observation-tick-input",
            "blockKind": "custom",
            "position": {
              "x": 40,
              "y": -864
          ...
          {
            "id": "fn-alpha-observation-tick-output",
            "blockKind": "custom",
            "position": {
              "x": 520,
              "y": 160
        ...
        "edges": [
          ...
          {
            "source": "fn-alpha-observation-tick-input",
          ...
          },
          {
            "source": "node-get-reporter-mqs5wkzi-169",
            "sourceHandle": "reporter",
            "target": "fn-alpha-observation-tick-output",
            "targetHandle": "reporter",
            "kind": "data",
            "dataType": "ReporterRef"
          },
