/**
 * Загрузка документа тарифной сетки
 * (S3/S9 плана интеграции; заседание `tariff-grid`, ратифицировано владельцем 29.07).
 *
 ...
 *
 * После #2333 внешний переключатель снят: валидная сетка сама является
 * единственным источником истины, а отсутствие/битость документа даёт честный
 * legacy-fallback без второго рубильника.
 */
