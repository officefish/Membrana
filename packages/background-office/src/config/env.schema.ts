...
export const envSchema = z.object({
  ...
  /** Plugin results (#1961): defaults to Archivarius Mongo, override when storage splits. */
  PLUGIN_RESULTS_MONGO_URI: z.string().optional(),
  PLUGIN_RESULTS_MONGO_DB: z.string().optional(),
