...
export const runRecordSchema = z
  ...
  // бы два облика одного дома. Возражение структурщика (теневой словарь через passthrough) записано
  // открытым P2 архитектору в OPEN.md спринта — закрывается карманом `payload` на стороне контракта
  // RunResult, если Архитектор так решит, а не срезом здесь.
  .passthrough();
