...
const HOME_NAMES = ['background-cabinet/journal', 'background-media/collections'] as const satisfies readonly HomeName[];
...
// true при неполном списке (ревью PR #1981). Текущие HomeName пакета: background-cabinet/journal ·
