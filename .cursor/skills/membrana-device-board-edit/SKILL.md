...
description: >-
  Guides edits to @membrana/device-board graph editor: undo depth=1, ScenarioRevertPolicy,
  branch navigation, function UX. Use when changing device-board graph, canvas, undo,
  breadcrumbs, or packages/device-board. Do NOT use for full Mintlify node reference
  (db-doc-v04-mvp) or runtime WebSocket MP7 without reading SCENARIO_RUNTIME.
---
