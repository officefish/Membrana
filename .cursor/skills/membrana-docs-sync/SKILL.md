...
description: >-
  Syncs Membrana documentation layers after code changes: Mintlify apps/docs, client
  catalog, CONCEPT/README, DOCUMENTATION_WORKFLOW RAG ritual. Use when user updates
  docs, Mintlify, catalog status, or asks docs:lint / catalog:verify-client / RAG index
  after doc PR. Do NOT use for ChatPRD PRD updates only (ChatPRD plugin) without repo docs.
---
