...
description: >-
  Configures Membrana MCP workstation tiers (phase-a through phase-d) and verifies
  bootstrap fragments. Use when user mentions mcp:phase, MCP bootstrap, Perplexity,
  Playwright, Glyph, or Mintlify MCP setup. Do NOT use for application runtime code.
---
