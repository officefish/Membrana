...
description: "Coordinates Membrana's five virtual team roles (Vesnin, Ozhegov, Dynin, Kuryokhin, Rodchenko) with standard response blocks. Use when user invokes /architect, /refactor, /math, /audio, /ui, /service, /review, or asks for virtual team format or LGTM. Do NOT use for full consilium protocol (membrana-consilium) or yarn ask single persona."
---
