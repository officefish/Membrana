...
description: "Post-competition catalog publish and operator debug for device-board UserCase forks. Use after Competition Sprint closure when user needs alpha/beta/gamma in picker, comp:publish-catalog, CATALOG_PUBLISH.json, or competition_packaging sprint. Do NOT use for mid-sprint team implementation (membrana-usercase-generation)."
---
