...
description: "Membrana code review ritual v0.2: tiers T0/T1/T2, severity P0–P2, yarn code-review modes (daily evening, PR, branch, uncommitted), output paths, LGTM/BLOCK format. Use when user asks for code review, вечернее ревью, PR review before merge, Teamlead LGTM on diff, or yarn code-review. Do NOT use for Bugbot/security-only scans (review-bugbot, review-security) or morning standup (read DAILY_CODE_REVIEW.md only — membrana-developer-rhythm)."
---
