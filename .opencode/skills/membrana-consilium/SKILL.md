...
description: "Runs Membrana virtual team consilium via yarn consilium with protocol saved to docs/seanses. Use for multi-role architectural or product disputes needing ≥30 role replies (6 советчиков; гости Фаррелл ≤3 и Ангелина-опровержение — сверх) and a written consensus. Do NOT use for single-persona yarn ask or routine code review."
---
# Membrana consilium
...
- **≥30 replies (шесть советчиков; гости — сверх счёта)** `[Роль]: …` in discussion body.
