...
description: "Scaffolds a new @membrana/*-service package in packages/services per docs/SERVICES.md. Use when user says /service, new service, foundation or analyzer service, or adding packages/services/*. Do NOT use for background-* NestJS servers (membrana-background-servers) or editing existing service business logic without scaffold intent."
---
