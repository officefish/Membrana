...
description: "Operates Membrana dual-circuit RAG when yarn rag:index and yarn rag:query exist. Use when indexing docs after merge, smoke queries, or RAG corpus paths. Do NOT run if package.json lacks rag scripts — report defer and point to DOCUMENTATION_WORKFLOW."
---
