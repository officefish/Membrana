...
description: "Builds and verifies device-board UserCase packs via scripts/usercase.mjs and regulation docs. Use when user mentions usercase, programmatic collapse, usercase pack, or device-board preset scenarios. Do NOT use for generic device-board graph editing without UserCase manifest (membrana-device-board-edit)."
---
