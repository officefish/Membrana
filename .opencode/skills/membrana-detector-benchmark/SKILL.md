...
description: "Runs Membrana detector build, test, benchmark, and calibration scripts for DSP drone detection services. Use when user mentions benchmark:detectors, calibrate:detectors, test:detectors, free-v1 dataset, or stage-gate reports. Do NOT use for adding new ML tier-2 detectors without INTEGRATIONS_STRATEGY review."
---
