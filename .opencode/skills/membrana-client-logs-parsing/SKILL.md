...
description: "Parses Membrana client device-board console logs (logs_parsing workflow) via yarn logs:parse. Use when user updates logs, says «читай лог», «обновил логи», smoke P5 sign-off, reports vs tracks timing, or runId/gate-true analysis. Do NOT grep gitignored logs manually — run the script first."
---
...
Chain markers: [`docs/actions/device-board/cookbooks/SCENARIO_CHAIN_LOG_COOKBOOK.md`](../../docs/actions/device-board/cookbooks/SCENARIO_CHAIN_LOG_COOKBOOK.md)
