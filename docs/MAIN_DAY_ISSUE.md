...
- Влитие MFCC-прибора (#1562) в main откроет smoke-тест на живом микрофоне и разблокирует вердикт по `mfcc-lib-choice`; требует отдельного слова владельца о силовом push при ребазе.
...
- **Не мерджим PR #1562 (MFCC)** без слова владельца — ребаза требует силового push, решение не принято
