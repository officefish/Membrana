...
|------|--------|-----------|
| **Teamlead** | Нагрузки и связки ролей, вердикты, ритм дня, приоритизация эпиков, приёмка исполнения | Лишний прикладной код; подмена ролей исполнителей; проектирование вместо Архитектора |
| **Архитектор** | Границы модулей и пакетов, контракты, форма решения, цена альтернатив, ADR | Планёрки и распределение работ (это Teamlead); прикладной код вместо исполнителей |
...
|------|----------|--------------|------------|--------|------------------|
| **Teamlead** | **Tarasov** (А. В. Тарасов — система: высочайшие нагрузки, сложные упражнения, коллективная комбинационная игра) | `tarasov` | `tarasov` | [аватар](https://i.pravatar.cc/400?u=membrana-tarasov) | [PROMPT_TEAMLEAD.md](./virtual-team/PROMPT_TEAMLEAD.md) |
| **Архитектор** | **Vesnin** (русский архитектурный авангард, конструктивизм; братья Веснины) — с 27.07 не тимлид: границы модулей, контракты, форма решения | `vesnin` | `vesnin` | [аватар](https://i.pravatar.cc/400?u=membrana-vesnin-1923) | [PROMPT_ARCHITECT.md](./virtual-team/PROMPT_ARCHITECT.md) |
