...
Каждая роль имеет имя-персонажа с исторической или культурной отсылкой. Имя используется как
...
Новых персонажей добавляют тем же паттерном (промпт в `virtual-team/`, строка в таблице ниже, `PERSONAS` в `ask-persona.mjs`).
...
| **Музыкант** | **Boyarskiy** (отсылка к образу М. С. Боярского — риск, решительность, темперамент; кредо *Pourquoi pas / Почему бы нет*) | `boyarskiy` | `boyarskiy` | [аватар](https://i.pravatar.cc/400?u=membrana-boyarskiy) | [PROMPT_MUSICIAN.md](./virtual-team/PROMPT_MUSICIAN.md) |
...
<https://i.pravatar.cc/400?u=membrana-vesnin-1923> · <https://i.pravatar.cc/400?u=membrana-ozhegov> · <https://i.pravatar.cc/400?u=membrana-dynin-math> · <https://i.pravatar.cc/400?u=membrana-boyarskiy> · <https://i.pravatar.cc/400?u=membrana-rodchenko>
...
yarn ask boyarskiy --gh-issue 47 "слышно ли drone-mr-120hz как дрон на колонках?"
...
Текущие персонажи: `vesnin`, `ozhegov`, `dynin`, `boyarskiy`, `rodchenko`.
