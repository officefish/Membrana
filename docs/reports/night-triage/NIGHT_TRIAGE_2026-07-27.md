# Night Triage 2026-07-27

**Сводка:** ghost 5 · orphan 158 · stale 106.

> Производный артефакт (sink not source): рекомендации, не действия — исполняет человек. Порог stale 14 дн. Сгенерирован 2026-07-27T23:30:00.006Z.
...
| --- | --- | --- | --- |
| `agent-tooling-night-build` | — | 19 | re-scope |
| `cabinet-scenario-picker-system` | — | 19 | re-scope |
| `cg2-two-tier-test-gate` | — | 25 | re-scope |
| `cg3-flaky-metrics-week` | — | 25 | re-scope |
| `cg4-ci-testing-docs` | — | 25 | re-scope |
| `ci-gate-stabilization` | — | 25 | re-scope |
| `comp-packaging-catalog-2026-06-25` | — | 32 | re-scope |
| `db-doc-v04-mvp` | — | 38 | re-scope |
| `db-h1b-board-shell` | — | 40 | re-scope |
| `db-h1c-graph-serialize` | — | 40 | re-scope |
| `db-h2a-json-import` | — | 40 | re-scope |
| `db-h2b-scenario-runtime` | — | 40 | re-scope |
| `db-h2c-mic-journal` | — | 40 | re-scope |
| `db-h2d-cabinet-sync` | — | 40 | re-scope |
| `db-h3a-trigger-stop` | — | 40 | re-scope |
| `db-h3b-trigger-disconnect` | — | 40 | re-scope |
| `db-h3c-subgraph` | — | 40 | re-scope |
| `db-h4-alarm-close` | — | 40 | re-scope |
| `db-p3-a1-usercase-catalog-service` | — | 33 | re-scope |
| `db-p3-a2-runtime-validators` | — | 33 | re-scope |
| `db-p3-a3-competition-restrictions` | — | 33 | re-scope |
| `db-post-usercase-roadmap` | — | 36 | re-scope |
| `db-sf-0-canon` | — | 31 | re-scope |
| `db-sf-1-core-contracts` | — | 31 | re-scope |
| `db-sf-2-gateway-board` | — | 31 | re-scope |
| `db-sf-3-cabinet-lease-api` | — | 31 | re-scope |
| `db-sf-4-client-follower` | — | 31 | re-scope |
| `db-sf-5-board-flags-ui` | — | 31 | re-scope |
| `db-sf-6-nodes-runtime` | — | 31 | re-scope |
| `db-sf-7-last-track-preview` | — | 31 | re-scope |
| `db-sf-8-tests-smoke` | — | 31 | re-scope |
| `db-sf-9-docs-sync` | — | 31 | re-scope |
| `db3h-s2-cabinet-host` | — | 31 | re-scope |
| `db3h-s4-microphone-detectors` | — | 31 | re-scope |
| `db3h-s5-desktop-logging` | — | 31 | re-scope |
| `detection-alarm-loop-refactor` | — | 16 | re-scope |
| `device-board-hackathon-1` | — | 40 | re-scope |
| `device-board-phase-3` | — | 33 | re-scope |
| `device-board-server-first` | — | 31 | re-scope |
| `device-board-three-hosts-2026-06-26` | — | 31 | re-scope |
| `drift-anchor-contour` | [#396](https://github.com/officefish/Membrana/issues/396) | 15 | re-scope |
| `fv1-s2-closeout` | — | 26 | re-scope |
| `live-parallel-detection-sprint` | — | 41 | re-scope |
| `lp1-mic-drone-stream-modes` | — | 41 | re-scope |
| `lp1b-drone-detailed-report-server` | — | 41 | re-scope |
| `lp2-fft-plugins-journal-sink` | — | 41 | re-scope |
| `lp3-track-import-backpressure` | — | 41 | re-scope |
| `lp4-parallel-detection-smoke` | — | 41 | re-scope |
| `lp5-journal-report-renderers` | — | 41 | re-scope |
| `media-library-a3-mic-recorder` | — | 47 | re-scope |
| `media-library-a4-sample-player` | — | 47 | re-scope |
| `membrane-node-runtime-remote` | — | 39 | re-scope |
| `mp7b-rt0-contract` | — | 39 | re-scope |
| `mp7b-rt1-gateway` | — | 39 | re-scope |
| `mp7b-rt2-client-runtime` | — | 39 | re-scope |
| `mp7b-rt3-mode` | — | 39 | re-scope |
| `mp7b-rt4-multinode-schema` | — | 39 | re-scope |
| `mp7b-rt5-cabinet-nodes` | — | 39 | re-scope |
| `mp7b-rt6-board-ux` | — | 39 | re-scope |
| `mp7b-rt7-prod-hardening` | — | 39 | re-scope |
| `nb-at-0-gate` | — | 19 | re-scope |
| `nb-at-1-gitignore-review` | — | 19 | re-scope |
| `nb-at-2-pr-ship` | — | 19 | re-scope |
| `nb-at-3-build-affected` | — | 19 | re-scope |
| `nb-at-4-verify-wire-sync` | — | 19 | re-scope |
| `nb-at-5-hooks` | — | 19 | re-scope |
| `nb-at-6-helpers` | — | 19 | re-scope |
| `nb-at-7-bookkeeping-gitctx` | — | 19 | re-scope |
| `nb-at-8-docs-skills` | — | 19 | re-scope |
| `nb-vlr-0-gate` | — | 24 | re-scope |
| `nb-vlr-1-labels-export-ui` | — | 24 | re-scope |
| `nb-vlr-2-labels-merge-script` | — | 24 | re-scope |
| `nb-vlr-3-library-label-filter` | — | 24 | re-scope |
| `nb-vlr-4-docs` | — | 24 | re-scope |
| `neural-free-tier-dataset-report` | — | 31 | re-scope |
| `neural-tier-1b-contract` | [#47](https://github.com/officefish/Membrana/issues/47) | 31 | re-scope |
| `oc-proxy-s0-research-isolation` | — | 32 | re-scope |
| `oc-proxy-s1-opencode-install` | — | 32 | re-scope |
| `oc-proxy-s2-freemodel-keys` | — | 32 | re-scope |
| `oc-proxy-s3-llm-proxy-script` | — | 32 | re-scope |
| `oc-proxy-s4-opencode-config` | — | 32 | re-scope |
| `opencode-proxy-sprint-2026-06-25` | — | 32 | re-scope |
| `partner-tutorials` | — | 21 | re-scope |
| `pcb-d2-multinode` | — | 23 | re-scope |
| `pt-0-tutorial-template` | — | 21 | re-scope |
| `pt-1-read-facts-sheet` | — | 21 | re-scope |
| `pt-2-first-output-v01-endtoend` | — | 21 | re-scope |
| `pt-3-honest-tech-storytelling` | — | 21 | re-scope |
| `rag-dual-circuit-v1` | — | 36 | re-scope |
| `rag-r6-closure` | — | 30 | re-scope |
| `rag-r7-optional` | — | 30 | re-scope |
| `real-dataset-live-calibration` | [#47](https://github.com/officefish/Membrana/issues/47) | 43 | re-scope |
| `sca-manual-smoke` | — | 24 | re-scope |
| `studio-capture-adaptation` | — | 24 | re-scope |
| `tech-debt-2026-07` | — | 19 | re-scope |
| `trends-fft-template-editor` | [#57](https://github.com/officefish/Membrana/issues/57) | 46 | re-scope |
| `ucv2-0-spec-lgtm` | — | 34 | re-scope |
| `ucv2-1-graph-collapse` | — | 34 | re-scope |
| `ucv2-2-freeze-async-tracks` | — | 34 | re-scope |
| `ucv2-3-pack-verify` | — | 34 | re-scope |
| `ucv2-4-operator-signoff` | — | 34 | re-scope |
| `usercase-mvp-v2-groups-async` | — | 34 | re-scope |
| `vdr-hard-gate` | [#47](https://github.com/officefish/Membrana/issues/47) | 24 | re-scope |
| `vdr-hg3-trends-benchmark` | [#47](https://github.com/officefish/Membrana/issues/47) | 24 | re-scope |
| `vdr-hg4-hard-gate-report` | [#47](https://github.com/officefish/Membrana/issues/47) | 24 | re-scope |
| `vdr-label-roundtrip-night-build` | — | 24 | re-scope |
