# Night Triage 2026-07-23

**Сводка:** ghost 5 · orphan 161 · stale 116.

> Производный артефакт (sink not source): рекомендации, не действия — исполняет человек. Порог stale 14 дн. Сгенерирован 2026-07-23T23:30:00.011Z.
...
| --- | --- | --- | --- |
| `agent-tooling-night-build` | — | 15 | re-scope |
| `cabinet-scenario-picker-system` | — | 15 | re-scope |
| `cg2-two-tier-test-gate` | — | 21 | re-scope |
| `cg3-flaky-metrics-week` | — | 21 | re-scope |
| `cg4-ci-testing-docs` | — | 21 | re-scope |
| `ci-gate-stabilization` | — | 21 | re-scope |
| `comp-packaging-catalog-2026-06-25` | — | 28 | re-scope |
| `db-ap-r1-core-contracts` | — | 28 | re-scope |
| `db-ap-r10-agenda-async-hub` | — | 28 | re-scope |
| `db-ap-r11-observability-tests` | — | 28 | re-scope |
| `db-ap-r12-docs-signoff` | — | 28 | re-scope |
| `db-ap-r2-core-sequence-latent` | — | 28 | re-scope |
| `db-ap-r3-async-job-store` | — | 28 | re-scope |
| `db-ap-r4-sequence-latent-runtime` | — | 28 | re-scope |
| `db-ap-r5-promise-nodes-editor` | — | 28 | re-scope |
| `db-ap-r6-promise-nodes-executor` | — | 28 | re-scope |
| `db-ap-r7-host-bridge-jobs` | — | 28 | re-scope |
| `db-ap-r8-detached-event-dispatch` | — | 28 | re-scope |
| `db-ap-r9-mvp-graph-v2` | — | 28 | re-scope |
| `db-doc-v04-mvp` | — | 34 | re-scope |
| `db-h1b-board-shell` | — | 36 | re-scope |
| `db-h1c-graph-serialize` | — | 36 | re-scope |
| `db-h2a-json-import` | — | 36 | re-scope |
| `db-h2b-scenario-runtime` | — | 36 | re-scope |
| `db-h2c-mic-journal` | — | 36 | re-scope |
| `db-h2d-cabinet-sync` | — | 36 | re-scope |
| `db-h3a-trigger-stop` | — | 36 | re-scope |
| `db-h3b-trigger-disconnect` | — | 36 | re-scope |
| `db-h3c-subgraph` | — | 36 | re-scope |
| `db-h4-alarm-close` | — | 36 | re-scope |
| `db-p3-a1-usercase-catalog-service` | — | 29 | re-scope |
| `db-p3-a2-runtime-validators` | — | 29 | re-scope |
| `db-p3-a3-competition-restrictions` | — | 29 | re-scope |
| `db-post-usercase-roadmap` | — | 32 | re-scope |
| `db-sf-0-canon` | — | 27 | re-scope |
| `db-sf-1-core-contracts` | — | 27 | re-scope |
| `db-sf-2-gateway-board` | — | 27 | re-scope |
| `db-sf-3-cabinet-lease-api` | — | 27 | re-scope |
| `db-sf-4-client-follower` | — | 27 | re-scope |
| `db-sf-5-board-flags-ui` | — | 27 | re-scope |
| `db-sf-6-nodes-runtime` | — | 27 | re-scope |
| `db-sf-7-last-track-preview` | — | 27 | re-scope |
| `db-sf-8-tests-smoke` | — | 27 | re-scope |
| `db-sf-9-docs-sync` | — | 27 | re-scope |
| `db3h-s2-cabinet-host` | — | 27 | re-scope |
| `db3h-s4-microphone-detectors` | — | 27 | re-scope |
| `db3h-s5-desktop-logging` | — | 27 | re-scope |
| `device-board-hackathon-1` | — | 36 | re-scope |
| `device-board-phase-3` | — | 29 | re-scope |
| `device-board-server-first` | — | 27 | re-scope |
| `device-board-three-hosts-2026-06-26` | — | 27 | re-scope |
| `fv1-s2-closeout` | — | 22 | re-scope |
| `live-parallel-detection-sprint` | — | 37 | re-scope |
| `lp1-mic-drone-stream-modes` | — | 37 | re-scope |
| `lp1b-drone-detailed-report-server` | — | 37 | re-scope |
| `lp2-fft-plugins-journal-sink` | — | 37 | re-scope |
| `lp3-track-import-backpressure` | — | 37 | re-scope |
| `lp4-parallel-detection-smoke` | — | 37 | re-scope |
| `lp5-journal-report-renderers` | — | 37 | re-scope |
| `media-library-a3-mic-recorder` | — | 43 | re-scope |
| `media-library-a4-sample-player` | — | 43 | re-scope |
| `membrane-node-runtime-remote` | — | 35 | re-scope |
| `mp7b-rt0-contract` | — | 35 | re-scope |
| `mp7b-rt1-gateway` | — | 35 | re-scope |
| `mp7b-rt2-client-runtime` | — | 35 | re-scope |
| `mp7b-rt3-mode` | — | 35 | re-scope |
| `mp7b-rt4-multinode-schema` | — | 35 | re-scope |
| `mp7b-rt5-cabinet-nodes` | — | 35 | re-scope |
| `mp7b-rt6-board-ux` | — | 35 | re-scope |
| `mp7b-rt7-prod-hardening` | — | 35 | re-scope |
| `nb-at-0-gate` | — | 15 | re-scope |
| `nb-at-1-gitignore-review` | — | 15 | re-scope |
| `nb-at-2-pr-ship` | — | 15 | re-scope |
| `nb-at-3-build-affected` | — | 15 | re-scope |
| `nb-at-4-verify-wire-sync` | — | 15 | re-scope |
| `nb-at-5-hooks` | — | 15 | re-scope |
| `nb-at-6-helpers` | — | 15 | re-scope |
| `nb-at-7-bookkeeping-gitctx` | — | 15 | re-scope |
| `nb-at-8-docs-skills` | — | 15 | re-scope |
| `nb-vlr-0-gate` | — | 20 | re-scope |
| `nb-vlr-1-labels-export-ui` | — | 20 | re-scope |
| `nb-vlr-2-labels-merge-script` | — | 20 | re-scope |
| `nb-vlr-3-library-label-filter` | — | 20 | re-scope |
| `nb-vlr-4-docs` | — | 20 | re-scope |
| `neural-free-tier-dataset-report` | — | 27 | re-scope |
| `neural-tier-1b-contract` | [#47](https://github.com/officefish/Membrana/issues/47) | 27 | re-scope |
| `oc-proxy-s0-research-isolation` | — | 28 | re-scope |
| `oc-proxy-s1-opencode-install` | — | 28 | re-scope |
| `oc-proxy-s2-freemodel-keys` | — | 28 | re-scope |
| `oc-proxy-s3-llm-proxy-script` | — | 28 | re-scope |
| `oc-proxy-s4-opencode-config` | — | 28 | re-scope |
| `opencode-proxy-sprint-2026-06-25` | — | 28 | re-scope |
| `partner-tutorials` | — | 17 | re-scope |
| `pcb-d2-multinode` | — | 19 | re-scope |
| `pt-0-tutorial-template` | — | 17 | re-scope |
| `pt-1-read-facts-sheet` | — | 17 | re-scope |
| `pt-2-first-output-v01-endtoend` | — | 17 | re-scope |
| `pt-3-honest-tech-storytelling` | — | 17 | re-scope |
| `rag-dual-circuit-v1` | — | 32 | re-scope |
| `rag-r6-closure` | — | 26 | re-scope |
| `rag-r7-optional` | — | 26 | re-scope |
| `real-dataset-live-calibration` | [#47](https://github.com/officefish/Membrana/issues/47) | 39 | re-scope |
| `sca-manual-smoke` | — | 20 | re-scope |
| `studio-capture-adaptation` | — | 20 | re-scope |
| `tech-debt-2026-07` | — | 15 | re-scope |
| `trends-fft-template-editor` | [#57](https://github.com/officefish/Membrana/issues/57) | 42 | re-scope |
| `ucv2-0-spec-lgtm` | — | 30 | re-scope |
| `ucv2-1-graph-collapse` | — | 30 | re-scope |
| `ucv2-2-freeze-async-tracks` | — | 30 | re-scope |
| `ucv2-3-pack-verify` | — | 30 | re-scope |
| `ucv2-4-operator-signoff` | — | 30 | re-scope |
| `usercase-mvp-v2-groups-async` | — | 30 | re-scope |
| `vdr-hard-gate` | [#47](https://github.com/officefish/Membrana/issues/47) | 20 | re-scope |
| `vdr-hg3-trends-benchmark` | [#47](https://github.com/officefish/Membrana/issues/47) | 20 | re-scope |
| `vdr-hg4-hard-gate-report` | [#47](https://github.com/officefish/Membrana/issues/47) | 20 | re-scope |
| `vdr-label-roundtrip-night-build` | — | 20 | re-scope |
