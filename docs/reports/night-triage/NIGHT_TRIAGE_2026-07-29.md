# Night Triage 2026-07-29

**Сводка:** ghost 5 · orphan 156 · stale 104.

> Производный артефакт (sink not source): рекомендации, не действия — исполняет человек. Порог stale 14 дн. Сгенерирован 2026-07-29T23:30:00.004Z.
...
| --- | --- | --- | --- |
| `agent-tooling-night-build` | — | 21 | re-scope |
| `cabinet-scenario-picker-system` | — | 21 | re-scope |
| `cg2-two-tier-test-gate` | — | 27 | re-scope |
| `cg3-flaky-metrics-week` | — | 27 | re-scope |
| `cg4-ci-testing-docs` | — | 27 | re-scope |
| `ci-gate-stabilization` | — | 27 | re-scope |
| `comp-packaging-catalog-2026-06-25` | — | 34 | re-scope |
| `db-doc-v04-mvp` | — | 40 | re-scope |
| `db-h1b-board-shell` | — | 42 | re-scope |
| `db-h1c-graph-serialize` | — | 42 | re-scope |
| `db-h2a-json-import` | — | 42 | re-scope |
| `db-h2b-scenario-runtime` | — | 42 | re-scope |
| `db-h2c-mic-journal` | — | 42 | re-scope |
| `db-h2d-cabinet-sync` | — | 42 | re-scope |
| `db-h3a-trigger-stop` | — | 42 | re-scope |
| `db-h3b-trigger-disconnect` | — | 42 | re-scope |
| `db-h3c-subgraph` | — | 42 | re-scope |
| `db-h4-alarm-close` | — | 42 | re-scope |
| `db-p3-a1-usercase-catalog-service` | — | 35 | re-scope |
| `db-p3-a2-runtime-validators` | — | 35 | re-scope |
| `db-p3-a3-competition-restrictions` | — | 35 | re-scope |
| `db-post-usercase-roadmap` | — | 38 | re-scope |
| `db-sf-0-canon` | — | 33 | re-scope |
| `db-sf-1-core-contracts` | — | 33 | re-scope |
| `db-sf-2-gateway-board` | — | 33 | re-scope |
| `db-sf-3-cabinet-lease-api` | — | 33 | re-scope |
| `db-sf-4-client-follower` | — | 33 | re-scope |
| `db-sf-5-board-flags-ui` | — | 33 | re-scope |
| `db-sf-6-nodes-runtime` | — | 33 | re-scope |
| `db-sf-7-last-track-preview` | — | 33 | re-scope |
| `db-sf-8-tests-smoke` | — | 33 | re-scope |
| `db-sf-9-docs-sync` | — | 33 | re-scope |
| `db3h-s2-cabinet-host` | — | 33 | re-scope |
| `db3h-s4-microphone-detectors` | — | 33 | re-scope |
| `db3h-s5-desktop-logging` | — | 33 | re-scope |
| `detection-alarm-loop-refactor` | — | 18 | re-scope |
| `device-board-hackathon-1` | — | 42 | re-scope |
| `device-board-phase-3` | — | 35 | re-scope |
| `device-board-server-first` | — | 33 | re-scope |
| `device-board-three-hosts-2026-06-26` | — | 33 | re-scope |
| `drift-anchor-contour` | [#396](https://github.com/officefish/Membrana/issues/396) | 17 | re-scope |
| `fv1-s2-closeout` | — | 28 | re-scope |
| `live-parallel-detection-sprint` | — | 43 | re-scope |
| `lp1-mic-drone-stream-modes` | — | 43 | re-scope |
| `lp1b-drone-detailed-report-server` | — | 43 | re-scope |
| `lp2-fft-plugins-journal-sink` | — | 43 | re-scope |
| `lp3-track-import-backpressure` | — | 43 | re-scope |
| `lp4-parallel-detection-smoke` | — | 43 | re-scope |
| `lp5-journal-report-renderers` | — | 43 | re-scope |
| `media-library-a3-mic-recorder` | — | 49 | re-scope |
| `media-library-a4-sample-player` | — | 49 | re-scope |
| `membrane-node-runtime-remote` | — | 41 | re-scope |
| `mp7b-rt0-contract` | — | 41 | re-scope |
| `mp7b-rt1-gateway` | — | 41 | re-scope |
| `mp7b-rt2-client-runtime` | — | 41 | re-scope |
| `mp7b-rt3-mode` | — | 41 | re-scope |
| `mp7b-rt4-multinode-schema` | — | 41 | re-scope |
| `mp7b-rt5-cabinet-nodes` | — | 41 | re-scope |
| `mp7b-rt6-board-ux` | — | 41 | re-scope |
| `mp7b-rt7-prod-hardening` | — | 41 | re-scope |
| `nb-at-0-gate` | — | 21 | re-scope |
| `nb-at-1-gitignore-review` | — | 21 | re-scope |
| `nb-at-2-pr-ship` | — | 21 | re-scope |
| `nb-at-3-build-affected` | — | 21 | re-scope |
| `nb-at-4-verify-wire-sync` | — | 21 | re-scope |
| `nb-at-5-hooks` | — | 21 | re-scope |
| `nb-at-6-helpers` | — | 21 | re-scope |
| `nb-at-7-bookkeeping-gitctx` | — | 21 | re-scope |
| `nb-at-8-docs-skills` | — | 21 | re-scope |
| `nb-vlr-0-gate` | — | 26 | re-scope |
| `nb-vlr-1-labels-export-ui` | — | 26 | re-scope |
| `nb-vlr-2-labels-merge-script` | — | 26 | re-scope |
| `nb-vlr-3-library-label-filter` | — | 26 | re-scope |
| `nb-vlr-4-docs` | — | 26 | re-scope |
| `neural-free-tier-dataset-report` | — | 33 | re-scope |
| `neural-tier-1b-contract` | [#47](https://github.com/officefish/Membrana/issues/47) | 33 | re-scope |
| `oc-proxy-s0-research-isolation` | — | 34 | re-scope |
| `oc-proxy-s1-opencode-install` | — | 34 | re-scope |
| `oc-proxy-s2-freemodel-keys` | — | 34 | re-scope |
| `oc-proxy-s3-llm-proxy-script` | — | 34 | re-scope |
| `oc-proxy-s4-opencode-config` | — | 34 | re-scope |
| `opencode-proxy-sprint-2026-06-25` | — | 34 | re-scope |
| `partner-tutorials` | — | 23 | re-scope |
| `pcb-d2-multinode` | — | 25 | re-scope |
| `pt-0-tutorial-template` | — | 23 | re-scope |
| `pt-1-read-facts-sheet` | — | 23 | re-scope |
| `pt-2-first-output-v01-endtoend` | — | 23 | re-scope |
| `pt-3-honest-tech-storytelling` | — | 23 | re-scope |
| `rag-dual-circuit-v1` | — | 38 | re-scope |
| `real-dataset-live-calibration` | [#47](https://github.com/officefish/Membrana/issues/47) | 45 | re-scope |
| `sca-manual-smoke` | — | 26 | re-scope |
| `studio-capture-adaptation` | — | 26 | re-scope |
| `tech-debt-2026-07` | — | 21 | re-scope |
| `trends-fft-template-editor` | [#57](https://github.com/officefish/Membrana/issues/57) | 48 | re-scope |
| `ucv2-0-spec-lgtm` | — | 36 | re-scope |
| `ucv2-1-graph-collapse` | — | 36 | re-scope |
| `ucv2-2-freeze-async-tracks` | — | 36 | re-scope |
| `ucv2-3-pack-verify` | — | 36 | re-scope |
| `ucv2-4-operator-signoff` | — | 36 | re-scope |
| `usercase-mvp-v2-groups-async` | — | 36 | re-scope |
| `vdr-hard-gate` | [#47](https://github.com/officefish/Membrana/issues/47) | 26 | re-scope |
| `vdr-hg3-trends-benchmark` | [#47](https://github.com/officefish/Membrana/issues/47) | 26 | re-scope |
| `vdr-hg4-hard-gate-report` | [#47](https://github.com/officefish/Membrana/issues/47) | 26 | re-scope |
| `vdr-label-roundtrip-night-build` | — | 26 | re-scope |
