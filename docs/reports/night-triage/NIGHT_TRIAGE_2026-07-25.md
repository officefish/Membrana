# Night Triage 2026-07-25

**Сводка:** ghost 5 · orphan 150 · stale 104.

> Производный артефакт (sink not source): рекомендации, не действия — исполняет человек. Порог stale 14 дн. Сгенерирован 2026-07-25T23:30:00.006Z.
...
| --- | --- | --- | --- |
| `agent-tooling-night-build` | — | 17 | re-scope |
| `cabinet-scenario-picker-system` | — | 17 | re-scope |
| `cg2-two-tier-test-gate` | — | 23 | re-scope |
| `cg3-flaky-metrics-week` | — | 23 | re-scope |
| `cg4-ci-testing-docs` | — | 23 | re-scope |
| `ci-gate-stabilization` | — | 23 | re-scope |
| `comp-packaging-catalog-2026-06-25` | — | 30 | re-scope |
| `db-doc-v04-mvp` | — | 36 | re-scope |
| `db-h1b-board-shell` | — | 38 | re-scope |
| `db-h1c-graph-serialize` | — | 38 | re-scope |
| `db-h2a-json-import` | — | 38 | re-scope |
| `db-h2b-scenario-runtime` | — | 38 | re-scope |
| `db-h2c-mic-journal` | — | 38 | re-scope |
| `db-h2d-cabinet-sync` | — | 38 | re-scope |
| `db-h3a-trigger-stop` | — | 38 | re-scope |
| `db-h3b-trigger-disconnect` | — | 38 | re-scope |
| `db-h3c-subgraph` | — | 38 | re-scope |
| `db-h4-alarm-close` | — | 38 | re-scope |
| `db-p3-a1-usercase-catalog-service` | — | 31 | re-scope |
| `db-p3-a2-runtime-validators` | — | 31 | re-scope |
| `db-p3-a3-competition-restrictions` | — | 31 | re-scope |
| `db-post-usercase-roadmap` | — | 34 | re-scope |
| `db-sf-0-canon` | — | 29 | re-scope |
| `db-sf-1-core-contracts` | — | 29 | re-scope |
| `db-sf-2-gateway-board` | — | 29 | re-scope |
| `db-sf-3-cabinet-lease-api` | — | 29 | re-scope |
| `db-sf-4-client-follower` | — | 29 | re-scope |
| `db-sf-5-board-flags-ui` | — | 29 | re-scope |
| `db-sf-6-nodes-runtime` | — | 29 | re-scope |
| `db-sf-7-last-track-preview` | — | 29 | re-scope |
| `db-sf-8-tests-smoke` | — | 29 | re-scope |
| `db-sf-9-docs-sync` | — | 29 | re-scope |
| `db3h-s2-cabinet-host` | — | 29 | re-scope |
| `db3h-s4-microphone-detectors` | — | 29 | re-scope |
| `db3h-s5-desktop-logging` | — | 29 | re-scope |
| `device-board-hackathon-1` | — | 38 | re-scope |
| `device-board-phase-3` | — | 31 | re-scope |
| `device-board-server-first` | — | 29 | re-scope |
| `device-board-three-hosts-2026-06-26` | — | 29 | re-scope |
| `fv1-s2-closeout` | — | 24 | re-scope |
| `live-parallel-detection-sprint` | — | 39 | re-scope |
| `lp1-mic-drone-stream-modes` | — | 39 | re-scope |
| `lp1b-drone-detailed-report-server` | — | 39 | re-scope |
| `lp2-fft-plugins-journal-sink` | — | 39 | re-scope |
| `lp3-track-import-backpressure` | — | 39 | re-scope |
| `lp4-parallel-detection-smoke` | — | 39 | re-scope |
| `lp5-journal-report-renderers` | — | 39 | re-scope |
| `media-library-a3-mic-recorder` | — | 45 | re-scope |
| `media-library-a4-sample-player` | — | 45 | re-scope |
| `membrane-node-runtime-remote` | — | 37 | re-scope |
| `mp7b-rt0-contract` | — | 37 | re-scope |
| `mp7b-rt1-gateway` | — | 37 | re-scope |
| `mp7b-rt2-client-runtime` | — | 37 | re-scope |
| `mp7b-rt3-mode` | — | 37 | re-scope |
| `mp7b-rt4-multinode-schema` | — | 37 | re-scope |
| `mp7b-rt5-cabinet-nodes` | — | 37 | re-scope |
| `mp7b-rt6-board-ux` | — | 37 | re-scope |
| `mp7b-rt7-prod-hardening` | — | 37 | re-scope |
| `nb-at-0-gate` | — | 17 | re-scope |
| `nb-at-1-gitignore-review` | — | 17 | re-scope |
| `nb-at-2-pr-ship` | — | 17 | re-scope |
| `nb-at-3-build-affected` | — | 17 | re-scope |
| `nb-at-4-verify-wire-sync` | — | 17 | re-scope |
| `nb-at-5-hooks` | — | 17 | re-scope |
| `nb-at-6-helpers` | — | 17 | re-scope |
| `nb-at-7-bookkeeping-gitctx` | — | 17 | re-scope |
| `nb-at-8-docs-skills` | — | 17 | re-scope |
| `nb-vlr-0-gate` | — | 22 | re-scope |
| `nb-vlr-1-labels-export-ui` | — | 22 | re-scope |
| `nb-vlr-2-labels-merge-script` | — | 22 | re-scope |
| `nb-vlr-3-library-label-filter` | — | 22 | re-scope |
| `nb-vlr-4-docs` | — | 22 | re-scope |
| `neural-free-tier-dataset-report` | — | 29 | re-scope |
| `neural-tier-1b-contract` | [#47](https://github.com/officefish/Membrana/issues/47) | 29 | re-scope |
| `oc-proxy-s0-research-isolation` | — | 30 | re-scope |
| `oc-proxy-s1-opencode-install` | — | 30 | re-scope |
| `oc-proxy-s2-freemodel-keys` | — | 30 | re-scope |
| `oc-proxy-s3-llm-proxy-script` | — | 30 | re-scope |
| `oc-proxy-s4-opencode-config` | — | 30 | re-scope |
| `opencode-proxy-sprint-2026-06-25` | — | 30 | re-scope |
| `partner-tutorials` | — | 19 | re-scope |
| `pcb-d2-multinode` | — | 21 | re-scope |
| `pt-0-tutorial-template` | — | 19 | re-scope |
| `pt-1-read-facts-sheet` | — | 19 | re-scope |
| `pt-2-first-output-v01-endtoend` | — | 19 | re-scope |
| `pt-3-honest-tech-storytelling` | — | 19 | re-scope |
| `rag-dual-circuit-v1` | — | 34 | re-scope |
| `rag-r6-closure` | — | 28 | re-scope |
| `rag-r7-optional` | — | 28 | re-scope |
| `real-dataset-live-calibration` | [#47](https://github.com/officefish/Membrana/issues/47) | 41 | re-scope |
| `sca-manual-smoke` | — | 22 | re-scope |
| `studio-capture-adaptation` | — | 22 | re-scope |
| `tech-debt-2026-07` | — | 17 | re-scope |
| `trends-fft-template-editor` | [#57](https://github.com/officefish/Membrana/issues/57) | 44 | re-scope |
| `ucv2-0-spec-lgtm` | — | 32 | re-scope |
| `ucv2-1-graph-collapse` | — | 32 | re-scope |
| `ucv2-2-freeze-async-tracks` | — | 32 | re-scope |
| `ucv2-3-pack-verify` | — | 32 | re-scope |
| `ucv2-4-operator-signoff` | — | 32 | re-scope |
| `usercase-mvp-v2-groups-async` | — | 32 | re-scope |
| `vdr-hard-gate` | [#47](https://github.com/officefish/Membrana/issues/47) | 22 | re-scope |
| `vdr-hg3-trends-benchmark` | [#47](https://github.com/officefish/Membrana/issues/47) | 22 | re-scope |
| `vdr-hg4-hard-gate-report` | [#47](https://github.com/officefish/Membrana/issues/47) | 22 | re-scope |
| `vdr-label-roundtrip-night-build` | — | 22 | re-scope |
