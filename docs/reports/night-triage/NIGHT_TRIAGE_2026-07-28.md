# Night Triage 2026-07-28

**Сводка:** ghost 5 · orphan 158 · stale 106.

> Производный артефакт (sink not source): рекомендации, не действия — исполняет человек. Порог stale 14 дн. Сгенерирован 2026-07-28T23:30:00.024Z.
...
| --- | --- | --- | --- |
| `agent-tooling-night-build` | — | 20 | re-scope |
| `cabinet-scenario-picker-system` | — | 20 | re-scope |
| `cg2-two-tier-test-gate` | — | 26 | re-scope |
| `cg3-flaky-metrics-week` | — | 26 | re-scope |
| `cg4-ci-testing-docs` | — | 26 | re-scope |
| `ci-gate-stabilization` | — | 26 | re-scope |
| `comp-packaging-catalog-2026-06-25` | — | 33 | re-scope |
| `db-doc-v04-mvp` | — | 39 | re-scope |
| `db-h1b-board-shell` | — | 41 | re-scope |
| `db-h1c-graph-serialize` | — | 41 | re-scope |
| `db-h2a-json-import` | — | 41 | re-scope |
| `db-h2b-scenario-runtime` | — | 41 | re-scope |
| `db-h2c-mic-journal` | — | 41 | re-scope |
| `db-h2d-cabinet-sync` | — | 41 | re-scope |
| `db-h3a-trigger-stop` | — | 41 | re-scope |
| `db-h3b-trigger-disconnect` | — | 41 | re-scope |
| `db-h3c-subgraph` | — | 41 | re-scope |
| `db-h4-alarm-close` | — | 41 | re-scope |
| `db-p3-a1-usercase-catalog-service` | — | 34 | re-scope |
| `db-p3-a2-runtime-validators` | — | 34 | re-scope |
| `db-p3-a3-competition-restrictions` | — | 34 | re-scope |
| `db-post-usercase-roadmap` | — | 37 | re-scope |
| `db-sf-0-canon` | — | 32 | re-scope |
| `db-sf-1-core-contracts` | — | 32 | re-scope |
| `db-sf-2-gateway-board` | — | 32 | re-scope |
| `db-sf-3-cabinet-lease-api` | — | 32 | re-scope |
| `db-sf-4-client-follower` | — | 32 | re-scope |
| `db-sf-5-board-flags-ui` | — | 32 | re-scope |
| `db-sf-6-nodes-runtime` | — | 32 | re-scope |
| `db-sf-7-last-track-preview` | — | 32 | re-scope |
| `db-sf-8-tests-smoke` | — | 32 | re-scope |
| `db-sf-9-docs-sync` | — | 32 | re-scope |
| `db3h-s2-cabinet-host` | — | 32 | re-scope |
| `db3h-s4-microphone-detectors` | — | 32 | re-scope |
| `db3h-s5-desktop-logging` | — | 32 | re-scope |
| `detection-alarm-loop-refactor` | — | 17 | re-scope |
| `device-board-hackathon-1` | — | 41 | re-scope |
| `device-board-phase-3` | — | 34 | re-scope |
| `device-board-server-first` | — | 32 | re-scope |
| `device-board-three-hosts-2026-06-26` | — | 32 | re-scope |
| `drift-anchor-contour` | [#396](https://github.com/officefish/Membrana/issues/396) | 16 | re-scope |
| `fv1-s2-closeout` | — | 27 | re-scope |
| `live-parallel-detection-sprint` | — | 42 | re-scope |
| `lp1-mic-drone-stream-modes` | — | 42 | re-scope |
| `lp1b-drone-detailed-report-server` | — | 42 | re-scope |
| `lp2-fft-plugins-journal-sink` | — | 42 | re-scope |
| `lp3-track-import-backpressure` | — | 42 | re-scope |
| `lp4-parallel-detection-smoke` | — | 42 | re-scope |
| `lp5-journal-report-renderers` | — | 42 | re-scope |
| `media-library-a3-mic-recorder` | — | 48 | re-scope |
| `media-library-a4-sample-player` | — | 48 | re-scope |
| `membrane-node-runtime-remote` | — | 40 | re-scope |
| `mp7b-rt0-contract` | — | 40 | re-scope |
| `mp7b-rt1-gateway` | — | 40 | re-scope |
| `mp7b-rt2-client-runtime` | — | 40 | re-scope |
| `mp7b-rt3-mode` | — | 40 | re-scope |
| `mp7b-rt4-multinode-schema` | — | 40 | re-scope |
| `mp7b-rt5-cabinet-nodes` | — | 40 | re-scope |
| `mp7b-rt6-board-ux` | — | 40 | re-scope |
| `mp7b-rt7-prod-hardening` | — | 40 | re-scope |
| `nb-at-0-gate` | — | 20 | re-scope |
| `nb-at-1-gitignore-review` | — | 20 | re-scope |
| `nb-at-2-pr-ship` | — | 20 | re-scope |
| `nb-at-3-build-affected` | — | 20 | re-scope |
| `nb-at-4-verify-wire-sync` | — | 20 | re-scope |
| `nb-at-5-hooks` | — | 20 | re-scope |
| `nb-at-6-helpers` | — | 20 | re-scope |
| `nb-at-7-bookkeeping-gitctx` | — | 20 | re-scope |
| `nb-at-8-docs-skills` | — | 20 | re-scope |
| `nb-vlr-0-gate` | — | 25 | re-scope |
| `nb-vlr-1-labels-export-ui` | — | 25 | re-scope |
| `nb-vlr-2-labels-merge-script` | — | 25 | re-scope |
| `nb-vlr-3-library-label-filter` | — | 25 | re-scope |
| `nb-vlr-4-docs` | — | 25 | re-scope |
| `neural-free-tier-dataset-report` | — | 32 | re-scope |
| `neural-tier-1b-contract` | [#47](https://github.com/officefish/Membrana/issues/47) | 32 | re-scope |
| `oc-proxy-s0-research-isolation` | — | 33 | re-scope |
| `oc-proxy-s1-opencode-install` | — | 33 | re-scope |
| `oc-proxy-s2-freemodel-keys` | — | 33 | re-scope |
| `oc-proxy-s3-llm-proxy-script` | — | 33 | re-scope |
| `oc-proxy-s4-opencode-config` | — | 33 | re-scope |
| `opencode-proxy-sprint-2026-06-25` | — | 33 | re-scope |
| `partner-tutorials` | — | 22 | re-scope |
| `pcb-d2-multinode` | — | 24 | re-scope |
| `pt-0-tutorial-template` | — | 22 | re-scope |
| `pt-1-read-facts-sheet` | — | 22 | re-scope |
| `pt-2-first-output-v01-endtoend` | — | 22 | re-scope |
| `pt-3-honest-tech-storytelling` | — | 22 | re-scope |
| `rag-dual-circuit-v1` | — | 37 | re-scope |
| `rag-r6-closure` | — | 31 | re-scope |
| `rag-r7-optional` | — | 31 | re-scope |
| `real-dataset-live-calibration` | [#47](https://github.com/officefish/Membrana/issues/47) | 44 | re-scope |
| `sca-manual-smoke` | — | 25 | re-scope |
| `studio-capture-adaptation` | — | 25 | re-scope |
| `tech-debt-2026-07` | — | 20 | re-scope |
| `trends-fft-template-editor` | [#57](https://github.com/officefish/Membrana/issues/57) | 47 | re-scope |
| `ucv2-0-spec-lgtm` | — | 35 | re-scope |
| `ucv2-1-graph-collapse` | — | 35 | re-scope |
| `ucv2-2-freeze-async-tracks` | — | 35 | re-scope |
| `ucv2-3-pack-verify` | — | 35 | re-scope |
| `ucv2-4-operator-signoff` | — | 35 | re-scope |
| `usercase-mvp-v2-groups-async` | — | 35 | re-scope |
| `vdr-hard-gate` | [#47](https://github.com/officefish/Membrana/issues/47) | 25 | re-scope |
| `vdr-hg3-trends-benchmark` | [#47](https://github.com/officefish/Membrana/issues/47) | 25 | re-scope |
| `vdr-hg4-hard-gate-report` | [#47](https://github.com/officefish/Membrana/issues/47) | 25 | re-scope |
| `vdr-label-roundtrip-night-build` | — | 25 | re-scope |
