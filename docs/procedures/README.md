...
## Ревизия корпуса (Ф5 #1220)

Инвентарь 19 процедур (11 built + 8 declared), вердикты keep/next, сверка
скиллов (срез) и проход легального «нет» на `gates` — [`CORPUS.md`](./CORPUS.md).
Зуб: `auditProcedureCorpus`. Полная сверка скиллов — [#1212](https://github.com/officefish/Membrana/issues/1212).
