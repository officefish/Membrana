...
| состояние | пять прогонов M1 отклонены; готовится шестой предаудит |
...
| **M1** | граница контейнера | run1–5 **BLOCK**; готовится run6 | [`повестка`](M1_AGENDA.md) · [`run1`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run1-carrier-identity-provenance.md) · [`run2`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run2-short-index-provenance.md) · [`run3`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run3-identity-unfinished-dod.md) · [`run4`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run4-negative-identity-intake.md) · [`run5`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run5-false-role-count.md) |
