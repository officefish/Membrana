...
| состояние | M3 ратифицирована; M4 external 5/5 закрыт; local-synthesis PASS, ожидается ратификация |
