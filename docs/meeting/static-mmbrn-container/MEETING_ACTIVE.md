...
| состояние | первый прогон M1 отклонён; готовится повторный предаудит |
...
| **M1** | граница контейнера | run1 **BLOCK**; готовится run2 | [`повестка`](M1_AGENDA.md) · [`run1`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run1-carrier-identity-provenance.md) |
