...
| состояние | M2 run16 отклонён постаудитом; повестка run17 прошла повторный предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run16 **BLOCK**; повторный предаудит run17 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
