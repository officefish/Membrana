...
| состояние | M2 run13 отклонён постаудитом; повестка run14 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run13 **BLOCK**; предаудит run14 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
