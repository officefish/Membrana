...
| состояние | M2 run15 отклонён постаудитом; компактная повестка run16 прошла повторный предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run15 **BLOCK**; повторный предаудит run16 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
