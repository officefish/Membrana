...
| состояние | M6 run1 BLOCK; внешний бюджет 1/5; предаудит run2 PASS, ожидается отдельное разрешение |
...
| **M6** | приём и выдача | **run1 BLOCK**; внешний бюджет **1/5**; **предаудит run2 PASS**, ожидается отдельное разрешение | [`повестка`](M6_AGENDA.md) · [`run1`](../../seanses/rejected/static-mmbrn-container-m6-intake-delivery-2026-08-06-run1-30-replies-m3-preview-idempotency.md) |
