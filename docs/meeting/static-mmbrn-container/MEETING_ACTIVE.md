...
| состояние | M6 **PASS local-synthesis**; внешний бюджет закрыт 5/5; ожидается ратификация владельца |
