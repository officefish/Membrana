...
| состояние | M2 run7 отклонён; повестка run8 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run7 **BLOCK**; предаудит run8 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
