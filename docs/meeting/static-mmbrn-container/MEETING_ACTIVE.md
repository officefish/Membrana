...
| состояние | два прогона M1 отклонены; готовится третий предаудит |
...
| **M1** | граница контейнера | run1–2 **BLOCK**; готовится run3 | [`повестка`](M1_AGENDA.md) · [`run1`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run1-carrier-identity-provenance.md) · [`run2`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run2-short-index-provenance.md) |
