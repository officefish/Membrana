...
| состояние | M2 run6 отклонён; компактная повестка run7 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run6 **BLOCK**; компактный run7 предаудит **PASS**, готов к созыву | [повестка](M2_AGENDA.md) |
