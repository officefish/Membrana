...
| состояние | M2 run8 отклонён; повестка run9 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run8 **BLOCK**; предаудит run9 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
