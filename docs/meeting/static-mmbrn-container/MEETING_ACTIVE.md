...
| состояние | M2 ратифицирована; M3 run1 отклонён, run2 прошёл предаудит и ожидает внешнего разрешения владельца |
...
| **M3** | доступ | run1 **BLOCK**; использовано **1/5**; предаудит run2 **PASS**, ожидает разрешения | [`повестка`](M3_AGENDA.md) · [`run1`](../../seanses/rejected/static-mmbrn-container-m3-access-2026-08-04-run1-seven-contract-defects.md) |
