...
| состояние | M5 ратифицирована; предаудит M6 PASS, ожидается отдельное разрешение |
...
| **M6** | приём и выдача | **предаудит PASS**, ожидается отдельное разрешение; внешний бюджет **0/5** | [`повестка`](M6_AGENDA.md) |
