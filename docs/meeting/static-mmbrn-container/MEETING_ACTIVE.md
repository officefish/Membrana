...
| состояние | M2 run17 отклонён постаудитом; повестка run18 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run17 **BLOCK**; предаудит run18 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
