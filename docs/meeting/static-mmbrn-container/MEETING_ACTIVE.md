...
| состояние | M2 run12 отклонён постаудитом; повестка run13 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run12 **BLOCK**; предаудит run13 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
