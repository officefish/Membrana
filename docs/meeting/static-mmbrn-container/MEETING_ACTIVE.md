...
| состояние | M2 run3 отклонён; исправленная повестка прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run3 **BLOCK**; повторный предаудит **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
