...
| состояние | M2 run14 отклонён постаудитом; повестка run15 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run14 **BLOCK**; предаудит run15 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
