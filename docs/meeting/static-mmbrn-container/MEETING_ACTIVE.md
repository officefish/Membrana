...
| состояние | M7 run1 BLOCK; внешний бюджет 1/5; предаудит run2 PASS, ожидается отдельное разрешение |
...
| **M7** | переезд и доставка | **run1 BLOCK**; внешний бюджет **1/5**; **предаудит run2 PASS**, ожидается отдельное разрешение | [`повестка`](M7_AGENDA.md) · [`run1`](../../seanses/rejected/static-mmbrn-container-m7-migration-delivery-2026-08-06-run1-m3-actions-rollout-cycles-inventory-retirement-predicates.md) |
