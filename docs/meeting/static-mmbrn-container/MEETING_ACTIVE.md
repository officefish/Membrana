...
| состояние | M2 run19 отклонён постаудитом; повестка run20 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run19 **BLOCK**; предаудит run20 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
