...
| состояние | M2 run11 отклонён; повестка run12 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run11 **BLOCK**; предаудит run12 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
