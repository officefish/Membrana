...
| состояние | M2 run6 отклонён; исправленная повестка прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run6 **BLOCK**; повторный предаудит **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
