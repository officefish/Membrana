...
| состояние | M2 run18 отклонён постаудитом; исправленная повестка run19 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run18 **BLOCK**; предаудит run19 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
