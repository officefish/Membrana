...
| состояние | M6 ратифицирована; предаудит M7 PASS; внешний бюджет M7 0/5; ожидается отдельное разрешение на run1 |
...
| **M7** | переезд и доставка | **предаудит PASS**; внешний бюджет **0/5**; ожидается отдельное разрешение на run1 | [`повестка`](M7_AGENDA.md) |
