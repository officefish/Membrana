...
| состояние | M5 local-synthesis PASS; внешний бюджет закрыт 5/5; ожидается ратификация владельца |
