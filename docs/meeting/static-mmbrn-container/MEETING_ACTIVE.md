...
| состояние | M5 run1 BLOCK; внешний бюджет 1/5; предаудит run2 PASS, ожидается отдельное разрешение |
...
| **M5** | роль Affine | **run1 BLOCK**; внешний бюджет **1/5**; **предаудит run2 PASS**, ожидается отдельное разрешение | [`повестка`](M5_AGENDA.md) · [`run1`](../../seanses/rejected/static-mmbrn-container-m5-affine-role-2026-08-05-run1-m3-actions-m6-binding-readiness.md) |
