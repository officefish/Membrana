...
| состояние | три прогона M1 отклонены; готовится четвёртый предаудит |
...
| **M1** | граница контейнера | run1–3 **BLOCK**; готовится run4 | [`повестка`](M1_AGENDA.md) · [`run1`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run1-carrier-identity-provenance.md) · [`run2`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run2-short-index-provenance.md) · [`run3`](../../seanses/rejected/static-mmbrn-container-m1-boundary-2026-08-03-run3-identity-unfinished-dod.md) |
