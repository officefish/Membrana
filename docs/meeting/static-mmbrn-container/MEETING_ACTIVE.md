...
| состояние | M2 run9 отклонён; повестка run10 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run9 **BLOCK**; предаудит run10 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
