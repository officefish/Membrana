...
| состояние | M2 run10 отклонён; повестка run11 прошла предаудит и готова к созыву |
...
| **M2** | тождество и источник истины | run1-run10 **BLOCK**; предаудит run11 **PASS**, готова к созыву | [повестка](M2_AGENDA.md) |
