...
## Состояние после заседания

Процедурный корпус записан этим PR #1521. После закрытия комнат runtime-контур был
реализован PR #1524, а production-провод MongoDB добавлен PR #1528. Это обновляет
состояние follow-up работ, но не превращает само заседание в доказательство L/O и не
доказывает наличие ненулевого архива записей.
