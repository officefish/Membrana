# Промпт: Грамматика веток: процедурная ветка — не транспорт; только артефакты процедуры по разрешению (провод Р4 + профиль сессии)
...
> Реестр: `id` = `procedural-branch-guard` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#925](https://github.com/officefish/Membrana/issues/925)
