# Промпт: Союзное слияние всех append-only журналов docs/**/*.jsonl (Б, после #2147)
...
> Реестр: `id` = `union-merge-all-jsonl` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#2096](https://github.com/officefish/Membrana/issues/2096)
