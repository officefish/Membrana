...
- [x] `kits/` дом + манифест по pl-r3 (#836)
- [x] Аудит полноты подграфа (PINNED_SUBGRAPH чеклист) (#838)
- [x] Живой кит `angelina-morning` с пинами (#841)
- [x] Процедура утра / `kitVersion` связана (#843)
- [x] Фазы архивированы со свидетельством PR (K0–K4; K5 + эпик — в closure)
