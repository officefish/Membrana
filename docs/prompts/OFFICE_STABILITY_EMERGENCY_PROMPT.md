# Промпт: АВАРИЯ: таймауты office — server-first не выполняется; починка до строительства роутера (T10)
...
> Реестр: `id` = `office-stability-emergency` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#933](https://github.com/officefish/Membrana/issues/933)
