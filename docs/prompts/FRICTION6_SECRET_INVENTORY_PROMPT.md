# Промпт: yarn secret:inventory — инвентарь засвеченного как вход ротации ключей
...
> Реестр: `id` = `friction6-secret-inventory` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1266](https://github.com/officefish/Membrana/issues/1266)
