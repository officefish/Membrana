# Промпт: root-domain-scenarios-docs: доки на membrana.space/scenarios/docs (Mintlify subpath-proxy) + root-Caddy на cabinet-VPS
...
> Реестр: `id` = `root-domain-scenarios-docs` в [`docs/tasks/registry.json`](../tasks/registry.json).
