# Промпт: Эпик: контейнер тестов — дом в корневом tests/, кит, мастерская, сетапы и ночной полный прогон
...
> Реестр: `id` = `tests-container` в [`docs/tasks/registry.json`](../tasks/registry.json).
