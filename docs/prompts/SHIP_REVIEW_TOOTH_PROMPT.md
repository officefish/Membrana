# Промпт: Шип-гейт: мердж только через ревью-вердикт по HEAD SHA + required check (стена от обхода ревью)
...
> Реестр: `id` = `ship-review-tooth` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#924](https://github.com/officefish/Membrana/issues/924)
