# Промпт: Заседание: контур исполнения виртуальной команды (контур 2)
...
> Реестр: `id` = `meeting-team-execution-contour` в [`docs/tasks/registry.json`](../tasks/registry.json).
