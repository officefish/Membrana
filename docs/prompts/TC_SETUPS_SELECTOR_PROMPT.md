# Промпт: Сетапы smoke/gate/full и селектор по графу импортов; отчёт «что не гонялось»
...
> Реестр: `id` = `tc-setups-selector` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1292](https://github.com/officefish/Membrana/issues/1292)
