# Промпт: Деплой видит живой сеанс: предикат «устройство занято» по возрасту последней пробы (В1)
...
> Реестр: `id` = `deploy-busy-device-predicate` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#2048](https://github.com/officefish/Membrana/issues/2048)
