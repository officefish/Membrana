# Промпт: Приём записи: измеренное перебивает объявленное — длительность/частота/каналы из WAV (В3)
...
> Реестр: `id` = `capture-measured-over-declared` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1950](https://github.com/officefish/Membrana/issues/1950)
