...
> Ожидаемый артефакт: **1 PR — команда сверяет строки топ-10 хендоффа с состояниями Issue/PR carriers**.
...
Дом — соседняя зона осмотра мастерской (docs/audit/tasks), рядом с tasks:audit: команда смотрит НАРУЖУ (состояния Issue/PR), а не в реестр. Сеть недоступна → honest unknown, не «живо».
