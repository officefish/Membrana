# Промпт: llm-транспорт: развести «ключа нет» и «ключ отвергнут»
...
> Реестр: `id` = `llm-transport-no-key-class` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1549](https://github.com/officefish/Membrana/issues/1549)
