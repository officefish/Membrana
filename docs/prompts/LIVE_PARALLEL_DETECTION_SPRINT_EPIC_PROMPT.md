...
1. Документировать SLO в README плагина / `docs/LIVE_PARALLEL_DETECTION.md` (кратко).
2. Vitest: stream window 3 с mock frames → 1 report.
3. Paired checklist в Issue.
