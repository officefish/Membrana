# Промпт: Разбор сеанса лицом: витрина session-digest в библиотеке по образцу чарт-листа (Г2)
...
> Реестр: `id` = `session-digest-library-face` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#2039](https://github.com/officefish/Membrana/issues/2039)
