...
| **MS6** | `membrana-studio-ms6-host-bridge` | 6 | Vesnin + Ozhegov | [`STUDIO_HOST_BRIDGE_CONTRACT.md`](../STUDIO_HOST_BRIDGE_CONTRACT.md), [`STUDIO_HOST_LESSONS.md`](../actions/device-board/STUDIO_HOST_LESSONS.md), smoke matrix browser/Studio | MS3 (параллельно DB3H-S3) |
...
2. Реестр [`STUDIO_HOST_LESSONS.md`](../actions/device-board/STUDIO_HOST_LESSONS.md) (STx) — по образцу L1–L23; консилиум [`studio-host-smoke-registry-2026-06-26.md`](../seanses/studio-host-smoke-registry-2026-06-26.md).
