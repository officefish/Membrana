...
**Ветка:** `night/linear-hygiene-dreams-providers-night-2026-07-20` ← `origin/main`.  
**Linear:** DRU-249.
...
1. `git status -sb`, ветка `night/linear-hygiene-dreams-providers-night-2026-07-20`, база = `origin/main`.
...
- [ ] PR `night/linear-hygiene-dreams-providers-night-2026-07-20` открыт, **не** смёржен ночью
