# Промпт: Граф правды: архитектура, реестр зависимых процессов, охлаждение сессии, инструменты редактирования
...
> Реестр: `id` = `truth-graph-contour` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#576](https://github.com/officefish/Membrana/issues/576)
