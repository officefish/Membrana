# Промпт: Agent tooling friction — раунд 6 (сессия 2026-07-26): ship не врёт, секрет-гейт не блокирует чужих
...
> Реестр: `id` = `agent-tooling-friction-6` в [`docs/tasks/registry.json`](../tasks/registry.json).
