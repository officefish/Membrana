...
Готовность хозяина остаётся внешним gate: R7 оригиналов держит cutover `NO-GO` до PASS readiness gates.

Решение владельца 2026-08-23: assets-container ждёт готовности контейнера оригиналов. Доменным слоем без хранения не стартуем, на временное хранилище не идём. Причина: главный зуб эпика — подтверждение фото сегодняшним числом — без хранилища не работает, а временное хранилище имеет привычку становиться постоянным. Эпик остаётся `active` с названным внешним блокером: R7 originals readiness gates.
