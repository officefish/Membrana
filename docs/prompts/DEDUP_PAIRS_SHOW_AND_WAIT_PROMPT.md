# Промпт: Чистка дублей в наборах: показать пары и ждать слова, не удалять по порогу (Г1)
...
> Реестр: `id` = `dedup-pairs-show-and-wait` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#2109](https://github.com/officefish/Membrana/issues/2109)
