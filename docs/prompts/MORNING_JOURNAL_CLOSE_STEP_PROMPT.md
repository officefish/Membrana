# Промпт: Шаг закрытия журнала у утра: статус по факту, а не константой в хвосте цепочки
...
> Реестр: `id` = `morning-journal-close-step` в [`docs/tasks/registry.json`](../tasks/registry.json).
