# Промпт: Легализовать ADR как процедуру: запись в реестре, ядро trigger/steps/gates, зуб на реестр записей
...
> Реестр: `id` = `adr-procedure-legalize` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1296](https://github.com/officefish/Membrana/issues/1296)
