...
> Реестр: `id` = `promo-redemptions-rate-limit` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1917](https://github.com/officefish/Membrana/issues/1917)
