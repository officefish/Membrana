# Промпт: Доставка в ствол внутри цепочки ритуала: ожидание CI как шаг, не второй заход (Б, после #2147)
...
> Реестр: `id` = `deliver-to-main-in-chain` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#2081](https://github.com/officefish/Membrana/issues/2081)
