# Промпт: ADR-0025 в коде: развести holder и moderator у фрейма
...
> Реестр: `id` = `frame-holder-moderator-split` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1781](https://github.com/officefish/Membrana/issues/1781)
