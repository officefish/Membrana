...
Коллективная **ретроспектива дня** виртуальной команды (шесть ролей — состав по docs/virtual-team/voices.registry.json, тимлид tarasov с 27.07): оценить утренние и вечерние артефакты, обсудить итоги в свободной форме, предложить фокус на завтра, проголосовать за полезность дня (шкала 1–10), подвести резюме Teamlead о соответствии стратегии дня.
...
| Горизонт дня | `docs/STRATEGY_DAY.md` | если есть |
| План дня | `docs/DAY_PLAN.md` | если есть |
...
- [ ] Все шесть ролей дали блок `[Роль]:` с оценкой артефактов и предложением на завтра.
