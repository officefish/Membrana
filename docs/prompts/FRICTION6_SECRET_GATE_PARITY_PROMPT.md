# Промпт: Секрет-гейт локально = CI: проверка по диапазону вместо растущей истории
...
> Реестр: `id` = `friction6-secret-gate-parity` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1262](https://github.com/officefish/Membrana/issues/1262)
