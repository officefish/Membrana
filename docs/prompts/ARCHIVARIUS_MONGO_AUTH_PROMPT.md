# Промпт: Archivarius-Mongo с аутентификацией: строка подключения с учётными данными (В4)
...
> Реестр: `id` = `archivarius-mongo-auth` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1753](https://github.com/officefish/Membrana/issues/1753)
