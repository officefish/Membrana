# Промпт: Dockerfile офиса: поимённый COPY дублирует граф импортов — сделать расхождение невозможным или видимым
...
> Реестр: `id` = `dockerfile-copy-manifest-drifts` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1797](https://github.com/officefish/Membrana/issues/1797)
