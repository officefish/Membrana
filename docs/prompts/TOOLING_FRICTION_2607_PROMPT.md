# Промпт: Тулинг-фрикции 25–26.07: скан по диффу, чужая база ветки, слияние в изоляции, честные отказы хуков
...
> Реестр: `id` = `tooling-friction-2607` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1272](https://github.com/officefish/Membrana/issues/1272)
