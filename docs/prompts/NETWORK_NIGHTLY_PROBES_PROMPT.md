# Промпт: Ночной такт 01:00: сбор зонд-снимков, транспорт в дом, registry-пересчёт (В4+В5)
...
> Реестр: `id` = `network-nightly-probes` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1913](https://github.com/officefish/Membrana/issues/1913)
