# Промпт: Узел к дежурству: предикат готовности Firebat — сон/гибернация/автовход/служба (Г4)
...
> Реестр: `id` = `node-duty-ready-predicate` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#2049](https://github.com/officefish/Membrana/issues/2049)
