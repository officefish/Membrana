# Промпт: Реестр скриптов не протухает + три грабли окружения в AGENTS.md
...
> Реестр: `id` = `friction6-hygiene-notes` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1265](https://github.com/officefish/Membrana/issues/1265)
