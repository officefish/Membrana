# Промпт: Контейнер тестов: дом в корневом tests/, кит tests-master, мастерская (homePath начинает работать)
...
> Реестр: `id` = `tc-home-workshop` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#1291](https://github.com/officefish/Membrana/issues/1291)
