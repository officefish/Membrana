# Промпт: Ласточки партнёрам: формулировка Ожеговым + явное одобрение владельца + память после отправки
...
> Реестр: `id` = `ally-swallow-editorial-gate` в [`docs/tasks/registry.json`](../tasks/registry.json).
...
**GitHub Issue:** [#569](https://github.com/officefish/Membrana/issues/569)
