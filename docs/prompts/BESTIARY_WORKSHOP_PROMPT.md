...
- [ ] Мастерская бестиария описана как **поставщик** ловушек; шов с HOME_WORKSHOP решён явно (исключение **или** правка паттерна — не «тихо оба»)
- [ ] Доп. реестры улова и документации ловушек живут в доме; `BESTIARY_LIST` не подменён
- [ ] Формат строки улова и строки ловушки/доки зафиксирован (T17); есть ≥1 пример каждой
- [ ] Антипаттерн = абстрактный шаблон (отдельный носитель); kit пинит только ловушку
- [ ] Mintlify-зеркало над git: страницы/навигация ссылаются на гранулы и доку ловушек; истина — в репо
- [ ] Жилец кита (имя на W4) с пинами prompts+scripts; `yarn kits:audit` зелёный; aim-пример («Ведьмак») в README
- [ ] CLOSURE; ACTIVE cleared; фазы + эпик archived со свидетельством PR
