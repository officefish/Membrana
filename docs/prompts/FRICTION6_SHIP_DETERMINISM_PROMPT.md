# Промпт: Ship перестаёт врать и проигрывать гонку: pr-wait бэкофф, pr-land на Windows, --auto, гард занятой base
...
**GitHub Issue:** [#1261](https://github.com/officefish/Membrana/issues/1261)
