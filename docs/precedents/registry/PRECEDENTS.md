...
> Meta · Date: 2026-07-31 · SHA: edcbf149 · Source: docs/precedents/*.md
> Пересобрать: `yarn precedent:register --rebuild`. Источник истины — файлы прецедентов.

Всего прецедентов: **21** · различных классов: **6** · доля рецидива: **71%** (ориентир ≤15%).
