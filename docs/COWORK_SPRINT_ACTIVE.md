...
| Поле | Значение |
|------|----------|
| **status** | `open` — Phase 5: PR [#675](https://github.com/officefish/Membrana/pull/675) integration → main открыт, ждёт мёржа; после мёржа — `yarn task:archive cowork-execution-registry` |
...
| 4 — Integration (ветка `cowork/cowork-execution-registry/integration`) | закрыта 2026-07-19: octopus без конфликтов, 6 адаптеров, smoke 16/16, DoD 137/137 + scoped CI office; переписано 0; гейт отказа-I закрыл 5 живых карточек (`449bbd03`) |
| 5 — Merge + RETROSPECTIVE + archive | **в работе**: PR #675 открыт, RETROSPECTIVE написана (`3a7529cf`); остаток — мёрж и архив карточки |
