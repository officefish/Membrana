...
| 5 — Merge + archive | в работе | 2026-09-07 | PR #2314 integration → main открыт (`00796347`; origin/main `fcd36c5f` влит в ветку, конфликты только в снимке сети и конфиге декомпозиции); мердж — слово владельца; `RETROSPECTIVE.md` написана; карточка — `task:archive` после мерджа. Поверх: #2310 в дереве `Membrana-cw-window`, ветка `feat/buffer-full-operator-window-2310` |
