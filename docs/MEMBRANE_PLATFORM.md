...
**Контракт трёх хостов (MS6):** [`STUDIO_HOST_BRIDGE_CONTRACT.md`](./STUDIO_HOST_BRIDGE_CONTRACT.md) — browser | Studio | cabinet; операционный дневник STx — [`device-board-scripts/STUDIO_HOST_LESSONS.md`](./device-board-scripts/STUDIO_HOST_LESSONS.md).
