...
> LGTM владельца 2026-07-15 (директива: ревью тимлида + мёрж PC-1). Решение по
> варианту A действует. Teamlead closure review: `docs/reviews/pc1-single-detector-report-teamlead.md`.
