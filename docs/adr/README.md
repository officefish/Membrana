...
|-----|------|--------|------|
| [ADR-0013](./ADR-0013-daily-audit-is-chronicle.md) | 2026-07-18 | DRAFT | `DAILY_AUDIT.md` — **хроника дня** (репозиторий · реестр задач · граф правды + строки по пяти областям), а не аудитор плана по форме F1/M4: сверка с планом и тернарный вердикт принадлежат документу-аудитору. Разрез областей и правило отнесения пути — канон, не деталь реализации |
