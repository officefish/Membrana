...
|-----|------|--------|------|
| [ADR-0017](./ADR-0017-linear-board-is-mirror.md) | 2026-07-23 | ACCEPTED | Linear UI-доска = зеркало GitHub; слой движения = `linear-snapshot@1` + `startedAt` + `yarn linear:movement-audit` · #1000 / DRU-364 · LGTM владельца 23.07 |
