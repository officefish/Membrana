...
| [ADR-0024](./ADR-0024-morning-gates-two-subjects-two-moments.md) | 2026-08-07 | DRAFT | Состояние утренних гейтов: ДВА субъекта (магистраль, ласточка) — ДВА момента вместо одного поля day. Предикат сверяет СВОЙ момент; ни один шаг не поднимает чужой; старое состояние читается как «оба момента неизвестны», а не наследуется. Грунт: morning-gate.mjs:61 (freeze сбрасывает оба) против morning-gate.mjs:111 (swallow --draft поднимает day, магистраль не трогая) — ложный owner-choice наблюдался трижды 05.08–07.08. Долг #gates-state-magistral-carryover, #1764. Ждёт LGTM владельца |
