...
|-----|------|--------|------|
| [ADR-0015](./ADR-0015-frame-pins-array-shape.md) | 2026-07-22 | DRAFT | Шов Ф1↔Ф3: канон `pins?: Pin[]` (не скаляр `pin?`); transitional чтение `pin`→`[pin]` в F1; запись F3 только `pins`. Спринт #900 F0 |
