...
- **v1.1** (2026-07-15) — секция «Делегированное исполнение» (ADR-0009): фазы NB0…NBn исполняет фоновый субагент в worktree, гардрейлы Р1–Р6, шаблон промпта ночного агента.
