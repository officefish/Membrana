...
> Сгенерировано: `2026-07-17T17:54:14.009Z` (`yarn night:open`)
> Регламент: [`NIGHT_SPRINT_REGULATION.md`](./NIGHT_SPRINT_REGULATION.md)

**Epic:** `agent-tooling-night-build`
**Старт:** 2026-07-17T17:54:14.009Z
**Ветка:** `night/agent-tooling-night-build-2026-07-17`
**Base:** `techies68`
...
- [ ] Ветка `night/agent-tooling-night-build-2026-07-17` создана от `techies68`
