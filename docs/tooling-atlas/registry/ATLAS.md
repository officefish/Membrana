...
Домов: **54** · из них мастерских: **13** · домов без мастерской: **41** · плоскостей: **3** · с полным набором из 3 глаголов: **6**.
...
| [docs/tasks](../../../docs/tasks/README.md) | `handoff` | `yarn task:handoff` | `docs/HANDOFF.md` |
