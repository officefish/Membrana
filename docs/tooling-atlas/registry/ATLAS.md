...
Домов: **56** · из них мастерских: **13** · домов без мастерской: **43** · плоскостей: **3** · с полным набором из 3 глаголов: **6**.
...
| [docs/audit/network](../../../docs/audit/network/README.md) | **Зонд-снимок** — результат одного акта наблюдения органом (`net:diag`, `llm:probe`, |
...
| [docs/procedures/duty](../../../docs/procedures/duty/README.md) | **Дом процедуры.** Ночь, когда полевой прибор пишет до полного буфера и штатно останавливается, |
...
| [docs/procedures/ritual-night](../../../docs/procedures/ritual-night/README.md) | Ночь получает свою дверь наравне с утром и вечером: манифест, фреймы, страж, честный отказ. |
...
| [docs/workflows](../../../docs/workflows/README.md) | Накопитель **проверяемых** примеров для объектов Mintlify-раздела Workflow: |
