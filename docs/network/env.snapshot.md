...
> Сгенерирован: 2026-09-11T15:06:06.849Z
...
|---|---|---|---|---|
| Контрольная точка (GitHub API) | control | `ok` | `ok` | — |
| Панель владельца (office) | provider | `ok` | `ok` | — |
| OpenRouter | provider | `ok` | `ok` | — |
| Anthropic | provider | `ok` | `ok` | — |
| DeepSeek | provider | `ok` | `ok` | — |
...
- снимок: 2026-09-11T15:06:06.849Z
- прокси в окружении: нет
- вердикт: сеть машины исправна — отказы провайдеров разбирать по их собственным причинам

| звено | исход | путь решает |
|---|---|---|
| Контрольная точка (GitHub API) | `ok` | нет |
| Панель владельца (office) | `ok` | нет |
| OpenRouter | `ok` | нет |
| Anthropic | `ok` | нет |
| DeepSeek | `ok` | нет |
