...
| **W3** | `dmd-w3-surface` | [#1125](https://github.com/officefish/Membrana/issues/1125) | ozhegov | [`DMD_W3_SURFACE_PROMPT.md`](../../prompts/DMD_W3_SURFACE_PROMPT.md) | Panel → harness URL; CUSTOM_DOMAIN notes | **in progress** (harness live 2026-07-24) |
