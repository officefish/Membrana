...
| **W2** | `dmd-w2-wires` | [#1124](https://github.com/officefish/Membrana/issues/1124) | ozhegov | [`DMD_W2_WIRES_PROMPT.md`](../../prompts/DMD_W2_WIRES_PROMPT.md) | atlas `--render` → harness path; CI ×2 | **done** (branch `feat/dual-mintlify-w2`) |
