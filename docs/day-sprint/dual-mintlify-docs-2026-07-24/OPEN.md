...
| **W2** | `dmd-w2-wires` | [#1124](https://github.com/officefish/Membrana/issues/1124) | ozhegov | [`DMD_W2_WIRES_PROMPT.md`](../../prompts/DMD_W2_WIRES_PROMPT.md) | atlas `--render` → harness path; CI ×2 | **done** (PR [#1132](https://github.com/officefish/Membrana/pull/1132)) |
| **W3** | `dmd-w3-surface` | [#1125](https://github.com/officefish/Membrana/issues/1125) | ozhegov | [`DMD_W3_SURFACE_PROMPT.md`](../../prompts/DMD_W3_SURFACE_PROMPT.md) | Panel → harness URL; CUSTOM_DOMAIN notes | **done** (PR [#1140](https://github.com/officefish/Membrana/pull/1140)) |
| **W4** | `dmd-w4-closure` | [#1126](https://github.com/officefish/Membrana/issues/1126) | vesnin | [`DMD_W4_CLOSURE_PROMPT.md`](../../prompts/DMD_W4_CLOSURE_PROMPT.md) | CLOSURE + owner DNS checklist | **done** |
