...
| **Branch** | `feature/sbc-s4-wiring` (фаза S4) |
...
| **S3** | `sbc-s3-kits-align` | [#795](https://github.com/officefish/Membrana/issues/795) | ozhegov | align kits ↔ pl-r3 | ✅ merged #822 |
| **S4** | `sbc-s4-wiring` | [#796](https://github.com/officefish/Membrana/issues/796) | vesnin | AGENTS / skills / DoD wires | ✅ LGTM vesnin 2026-07-21 |
