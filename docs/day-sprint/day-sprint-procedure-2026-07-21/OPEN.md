...
|-------|-------------|------:|------|--------|
| **F0** | `dsp-f0-brief` | [#849](https://github.com/officefish/Membrana/issues/849) | vesnin | ⬜ next (артефакты в дереве) |
| **F1** | `dsp-f1-inventory` | [#850](https://github.com/officefish/Membrana/issues/850) | ozhegov | ⬜ |
| **F2** | `dsp-f2-home` | [#851](https://github.com/officefish/Membrana/issues/851) | ozhegov | ⬜ |
| **F3** | `dsp-f3-regulation` | [#852](https://github.com/officefish/Membrana/issues/852) | ozhegov | ⬜ |
| **F4** | `dsp-f4-wire` | [#853](https://github.com/officefish/Membrana/issues/853) | ozhegov | ⬜ |
| **F5** | `dsp-f5-closure` | [#854](https://github.com/officefish/Membrana/issues/854) | vesnin | ⬜ |
