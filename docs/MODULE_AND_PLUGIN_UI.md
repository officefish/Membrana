...
### 3.0 Сторона сайдбара — основание, а не косметика

**Studio — слева, кабинет — справа.** Это не разнобой и не забытое выравнивание: стороны разные,
потому что разные рабочие места.

*Studio — прибор.* Экран компактный, часто ноутбучный или планшетный; оператор работает вплотную,
органы управления держит под рукой. Левый край ближе к тому месту, где рука уже находится.

*Кабинет — операторская.* Монитор берут под задачу, поле широкое, основное содержимое — лента,
таблица, карта — держится по центру и слева, куда падает первый взгляд при чтении. Служебный
список жильцов уходит вправо: туда взгляд приходит после работы с телом страницы, а не до неё.

**Выравнивать одно под другое нельзя.** Увидев разные стороны, легко принять это за небрежность
и «привести к одному» — но сторона следует физике рабочего места. Менять её допустимо только
вместе с рабочим местом: например, если кабинет начнут открывать с планшета как основной сценарий.

> Основание: Т8 шторма 22.08, блок B коворка `cowork-server-plugin-pages`. Развёрнутый текст —
