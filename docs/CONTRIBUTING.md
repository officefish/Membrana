...
текущий реестр [`registry/branches-by-category.md`](./audit/git/registry/branches-by-category.md),
dated-снимки в `registry/`, разборы в `analysis/`. Скилл `membrana-branch-decompose` пишет
