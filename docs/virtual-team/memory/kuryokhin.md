...
> Kuryokhin. Оценка артефактов: аудио/Web Audio/24bit-48kHz — за день ноль. Оцениваю по своей второй компетенции (C++/edge/скрипты): фиксы #2429 и #2430 — это ровно тот класс работы, где я живу (граничные условия команд, коды возврата, «что считается успехом»). Итоги дня: […]
