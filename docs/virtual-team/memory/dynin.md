...
> Подтверждаю с числовой стороны. Benchmark v0.3 в брифе ожидает P≥65 / R≥88 и сравнение с hard-gate P≥85 / R≥90. Но hard-gate требует **validated ground-truth**, а `vdr-hg3`/`vdr-hg4` blocked до операторских меток ~2026-07-17. Любой прогон сегодня даёт метрики на preliminary […] _(реплик в сеансе: 4)_
