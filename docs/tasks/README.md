...
| `fft-last-chance-calibration` | FFT — последний шанс: калибровка порога и trends на free-v1 (FL1–FL5) | 2026-06-16 | [`FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md`](../docs/prompts/FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md) | #84 (Issue открыт) | [карточка](./archive/fft-last-chance-calibration.md) |
| `fl1-sample-library-fft-threshold-plugin` | FL1: плагин FFT пороговый тест в библиотеке сэмплов | 2026-06-16 | [`FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md`](../docs/prompts/FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md) | #84 (Issue открыт) | [карточка](./archive/fl1-sample-library-fft-threshold-plugin.md) |
| `fl2-benchmark-fft-trends-harness` | FL2: Node-харнесс benchmark:fft-trends (threshold + trends) | 2026-06-16 | [`FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md`](../docs/prompts/FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md) | #84 (Issue открыт) | [карточка](./archive/fl2-benchmark-fft-trends-harness.md) |
| `fl3-threshold-calibration` | FL3: 3 конфигурации порогового теста на free-v1 | 2026-06-16 | [`FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md`](../docs/prompts/FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md) | #84 (Issue открыт) | [карточка](./archive/fl3-threshold-calibration.md) |
| `fl4-trends-template-calibration` | FL4: 3 комбинации trends-шаблонов + sweep minConfidence | 2026-06-16 | [`FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md`](../docs/prompts/FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md) | #84 (Issue открыт) | [карточка](./archive/fl4-trends-template-calibration.md) |
| `fl5-fft-last-chance-report` | FL5: отчёт go/no-go и архивация | 2026-06-16 | [`FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md`](../docs/prompts/FFT_LAST_CHANCE_CALIBRATION_EPIC_PROMPT.md) | #84 (Issue открыт) | [карточка](./archive/fl5-fft-last-chance-report.md) |
