...
| `membrane-platform-mp4-media-membrane` | Membrane Platform MP4: media scope по мембране, квоты userStorage/buffer, tariff dataset | L | [`MEMBRANE_PLATFORM_V1_EPIC_PROMPT.md`](../docs/prompts/MEMBRANE_PLATFORM_V1_EPIC_PROMPT.md) | [#67](https://github.com/officefish/Membrana/issues/67) |
