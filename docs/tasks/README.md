...
| `membrane-platform-mp1-auth-cabinet` | Membrane Platform MP1: background-cabinet auth + apps/cabinet shell | L | [`MEMBRANE_PLATFORM_V1_EPIC_PROMPT.md`](../docs/prompts/MEMBRANE_PLATFORM_V1_EPIC_PROMPT.md) | [#67](https://github.com/officefish/Membrana/issues/67) |
