...
| `membrane-platform-mp2-membrane-node-keys` | Membrane Platform MP2: Membrane, Tariff, Node, ключи TTL enum | M | [`MEMBRANE_PLATFORM_V1_EPIC_PROMPT.md`](../docs/prompts/MEMBRANE_PLATFORM_V1_EPIC_PROMPT.md) | [#67](https://github.com/officefish/Membrana/issues/67) |
| `membrane-platform-mp3-client-pairing` | Membrane Platform MP3: pairing в apps/client | M | [`MEMBRANE_PLATFORM_V1_EPIC_PROMPT.md`](../docs/prompts/MEMBRANE_PLATFORM_V1_EPIC_PROMPT.md) | [#67](https://github.com/officefish/Membrana/issues/67) |
