...
| **Phase now** | **W3** `bw-w3-mintlify` · [#949](https://github.com/officefish/Membrana/issues/949) |
| **Next** | W4 `bw-w4-trap-kit` · [#950](https://github.com/officefish/Membrana/issues/950) — после LGTM ozhegov на W3 |
| **Lead phase** | ozhegov |
| **Lead epic** | vesnin |
| **Opened** | 2026-07-22 |
