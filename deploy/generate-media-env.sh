...
MEDIA_PORT=3010
LOG_LEVEL=info
MEDIA_USER_STORAGE_QUOTA_BYTES_PER_DEVICE=1073741824
MEDIA_BUFFER_QUOTA_BYTES_PER_DEVICE=1073741824
...
CLIENT_CORS_ORIGINS=http://localhost:5173,http://localhost:5174,http://localhost:4173,https://cabinet.membrana.space
EOF
