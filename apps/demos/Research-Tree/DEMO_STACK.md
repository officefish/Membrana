...
## 5. ОТКРЫТЫЙ ВОПРОС: управление состоянием (исследовать отдельно)

> ⛔ **Этот раздел — НЕ решение, а план исследования.**
> Пользователь явно поручил исследовать state-инструмент отдельно, не принимать
> Zustand по инерции. Финальный выбор — после исследования.
