...
export const SampleWaveformScrubber: React.FC<SampleWaveformScrubberProps> = ({
  waveform,
  currentTimeSec,
  durationSec,
  onSeek,
  ...
  return (
    <div
      ...
      className={`relative w-full overflow-hidden rounded-lg border border-base-300 bg-base-300/50 ${
        compact ? 'cursor-pointer' : 'cursor-pointer'
      }`}
      style={{ height }}
