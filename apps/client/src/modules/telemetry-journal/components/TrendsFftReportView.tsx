...
import type { ConfidenceLevel, TrendsDetectionResult } from '@membrana/trends-detector-service';

import type { TrendsFftReport } from '../../../plugins/trends-fft-analyzer/buildTrendsFftReport';
import { TrendsMatchDetailTable } from '../../../plugins/trends-fft-analyzer/components/TrendsMatchDetailTable';
import { TrendsScoreRanking } from '../../../plugins/trends-fft-analyzer/components/TrendsScoreRanking';
...
/**
 * Expanded journal view for the FFT trends analyzer report (LP2). Mirrors the
 * sample-library lab view: winner verdict block, top-3 score ranking and an
 * on-demand per-template match breakdown table.
 */
