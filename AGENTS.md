...
- **Client browser console**: Paste DevTools output to `logs/apps/client/logs.txt` or `logs/apps/client/console-logs.txt` (gitignored); see `logs/README.md`. Agents: `yarn logs:parse` — skill `membrana-client-logs-parsing`, canon `docs/device-board-scripts/CLIENT_LOGS_PARSING.md`.
