...
| Antipattern bestiary | entry: [`docs/audit/bestiary/AGENT_PROMPT.md`](docs/audit/bestiary/AGENT_PROMPT.md) · контейнер `docs/audit/bestiary/` · `yarn bestiary:audit` · engines `scripts/lib/lens-bestiary.mjs` · эпик `bestiary-container` (#878) |
